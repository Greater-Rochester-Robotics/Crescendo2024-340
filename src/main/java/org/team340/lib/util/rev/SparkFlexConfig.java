...
public class SparkFlexConfig extends RevConfigBase<CANSparkFlex> {
    ...
    public void apply(CANSparkFlex sparkFlex) {
        ...
        applySteps(sparkFlex, identifier);
        RevConfigRegistry.addBurnFlash(identifier, () -> sparkFlex.burnFlash());
    }

    /**
     * Spark Flex CAN status frames.
     * @see https://docs.revrobotics.com/brushless/spark-max/control-interfaces#periodic-status-frames
     */
    public static enum Frame {
        /**
         * <h2><a href="https://docs.revrobotics.com/brushless/spark-max/control-interfaces#periodic-status-0-default-rate-10ms">Periodic Status 0</a></h2>
         *
        ...
        /**
         * <h2><a href="https://docs.revrobotics.com/brushless/spark-max/control-interfaces#periodic-status-1-default-rate-20ms">Periodic Status 1</a></h2>
         *
        ...
        /**
         * <h2><a href="https://docs.revrobotics.com/brushless/spark-max/control-interfaces#periodic-status-2-default-rate-20ms">Periodic Status 2</a></h2>
         *
         * <i>Default rate: {@code 20ms}</i>
         *
         * <h3> Frame content: </h3>
        ...
        /**
         * <h2><a href="https://docs.revrobotics.com/brushless/spark-max/control-interfaces#periodic-status-3-default-rate-50ms">Periodic Status 3</a></h2>
         *
        ...
        /**
         * <h2><a href="https://docs.revrobotics.com/brushless/spark-max/control-interfaces#periodic-status-4-default-rate-20ms">Periodic Status 4</a></h2>
         *
         * <i>Default rate: {@code 20ms}</i>
         *
         * <h3> Frame content: </h3>
        ...
        /**
         * <h2><a href="https://docs.revrobotics.com/brushless/spark-max/control-interfaces#periodic-status-5-default-rate-200ms">Periodic Status 5</a></h2>
         *
        ...
        /**
         * <h2><a href="https://docs.revrobotics.com/brushless/spark-max/control-interfaces#periodic-status-6-default-rate-200ms">Periodic Status 6</a></h2>
         *
         * <i>Default rate: {@code 200ms}</i>
         *
         * <h3> Frame content: </h3>
        ...
        /**
         * <h2><a href="https://docs.revrobotics.com/brushless/revlib/device-firmware-changelogs#version-24.0.0">Periodic Status 7</a></h2>
         *
         * <i>Default rate: {@code 250ms}</i>
         *
         * <h3> Frame content: </h3>
         *
         * <table>
         ...
         *   <tr>
         *     <th> IAccum </th>
         *     <th> I accumulator of the PID controller. </th>
         *   </tr>
         * </table>
         */
        S7(PeriodicFrame.kStatus7);
