...
public final class Constants {
    ...
    public static final class ControllerConstants {
        ...
        public static final double DRIVE_MULTIPLIER = 0.35;
        public static final double DRIVE_MULTIPLIER_MODIFIED = 0.8;

        public static final double DRIVE_ROT_EXP = 2.0;
        public static final double DRIVE_ROT_MULTIPLIER = 0.25;
        public static final double DRIVE_ROT_MULTIPLIER_MODIFIED = 0.8;
    ...
    public static final class SwerveConstants {
        ...
        public static final SwerveConfig CONFIG = new SwerveConfig()
            ...
            .setPeriod(PERIOD)
            .setMovePID(0.15, 0.0, 0.0, 0.0)
            .setMoveFF(0.13312, 2.3443, 0.0)
